...
export default function Installments() {
  ...
  // Função para salvar nova data de vencimento
  const handleSaveDueDate = async (id: string) => {
    ...
    try {
      ...
      setRows(prev => prev.map(r => r.id === id ? { ...r, due_date: newDueDate } : r));
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {editId === r.id ? (
                            <div className="flex items-center gap-2">
                              ...
                              />
                              <Button size="sm" variant="outline" onClick={() => handleSaveDueDate(r.id)}>
                                Salvar
                              </Button>
                              <Button size="sm" variant="ghost" onClick={() => { setEditId(null); setNewDueDate(""); }}>
                                Cancelar
                              </Button>
                            </div>
                          ) : (
                            <>
                              ...
                              <Button size="sm" variant="ghost" onClick={() => { setEditId(r.id); setNewDueDate(r.due_date.slice(0,10)); }}>
                                Editar
                              </Button>
                            </>
                          )}
